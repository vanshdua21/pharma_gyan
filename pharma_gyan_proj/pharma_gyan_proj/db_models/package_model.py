from pharma_gyan_proj.orm_models.v2.all_models import Package
from pharma_gyan_proj.utils.sqlalchemy_helper import fetch_count, fetch_package_rows_with_join, sql_alchemy_connect, save_or_update_merge, \
    update
...
class package_model:
    ...
    def get_details_by_filter_list(self, filter_list, columns_list=[], relationships_list=[]):
        res = fetch_package_rows_with_join(self.engine, self.table, filter_list, columns=columns_list,
