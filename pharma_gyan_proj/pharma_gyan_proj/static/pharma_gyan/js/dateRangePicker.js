!function(t, a) {
    ...
    function i(t, e, a) {
        ...
        "string" == typeof e.locale.customRangeLabel && ((l = document.createElement("textarea")).innerHTML = e.locale.customRangeLabel,
        c = l.value,
        ...
        0 != this.locale.firstDay)
            for (var h = this.locale.firstDay; 0 < h; )
                ...
                h--;
        if (void 0 === e.startDate && void 0 === e.endDate && R(this.element).is(":text") && (o = i = null,
        2 == (r = (n = R(this.element).val()).split(this.locale.separator)).length ? (o = j(r[0], this.locale.format),
        i = j(r[1], this.locale.format)) : this.singleDatePicker && "" !== n && (o = j(n, this.locale.format),
        i = j(n, this.locale.format)),
        null !== o && null !== i && (this.setStartDate(o),
        this.setEndDate(i))),
        "object" == typeof e.ranges) {
            for (s in e.ranges) {
                ...
                this.minDate && i.isBefore(this.minDate, this.timepicker ? "minute" : "day") || d && o.isAfter(d, this.timepicker ? "minute" : "day") || ((l = document.createElement("textarea")).innerHTML = s,
                c = l.value,
                this.ranges[c] = [o, i])
            }
            var m = "<ul>";
    ...
    return i.prototype = {
        ...
        renderCalendar: function(t) {
            ...
            for (var D = j([d, c, u, 12, n, r]), f = 0, g = 0, y = 0; f < 42; f++,
            g++,
            D = j(D).add(24, "hour"))
                0 < f && g % 7 == 0 && (g = 0,
                y++),
            ...
            C += "</thead>",
            C += "<tbody>",
            null == this.endDate && this.maxSpan && (v = this.startDate.clone().add(this.maxSpan).endOf("day"),
            b && !v.isBefore(b) || (b = v));
            for (y = 0; y < 6; y++) {
                C += "<tr>",
                ...
                for (g = 0; g < 7; g++) {
                    ...
                    !1 !== W && ("string" == typeof W ? E.push(W) : Array.prototype.push.apply(E, W));
                    for (var O = "", H = !1, f = 0; f < E.length; f++)
                        O += E[f] + " ",
                        "disabled" == E[f] && (H = !0);
                    H || (O += "available"),
                    C += '<td class="' + O.replace(/^\s+|\s+$/g, "") + '" data-title="r' + y + "c" + g + '">' + e[y][g].date() + "</td>"
                }
                C += "</tr>"
            }
            C += "</tbody>",
        ...
        renderTimePicker: function(t) {
            if ("right" != t || this.endDate) {
                ...
                i = this.startDate,
                "" != (s = this.container.find(".drp-calendar.right .calendar-time")).html() && (a.hour(isNaN(a.hour()) ? s.find(".hourselect option:selected").val() : a.hour()),
                ...
                this.timePicker24Hour || ("PM" === (n = s.find(".ampmselect option:selected").val()) && a.hour() < 12 && a.hour(a.hour() + 12),
                ...
                12 <= a.hour() ? e += '<option value="AM"' + p + '>AM</option><option value="PM" selected="selected"' + f + ">PM</option>" : e += '<option value="AM" selected="selected"' + p + '>AM</option><option value="PM"' + f + ">PM</option>",
                e += "</select>"),
        ...
        move: function() {
            ...
            var i, s, n = this.container.outerWidth();
            this.container["up" == this.drops ? "addClass" : "removeClass"]("drop-up"),
            "left" == this.opens ? n + (i = a - this.element.offset().left - this.element.outerWidth()) > R(window).width() ? this.container.css({
                top: t,
                right: "auto",
                left: 9
            }) : this.container.css({
                ...
                right: "auto",
                left: 9
            }) : s + n > R(window).width() ? this.container.css({
                top: t,
                left: "auto",
                right: 0
            }) : this.container.css({
                ...
                left: s,
                right: "auto"
            }) : (s = this.element.offset().left - e.left) + n > R(window).width() ? this.container.css({
                top: t,
                left: "auto",
                right: 0
            }) : this.container.css({
        ...
        clickRange: function(t) {
            ...
            (this.chosenLabel = a) == this.locale.customRangeLabel ? this.showCalendars() : (e = this.ranges[a],
            this.startDate = e[0],
            this.endDate = e[1],
        ...
        hoverDate: function(t) {
            var e, a, i, r, o, h, l;
            R(t.target).hasClass("available") && (a = (e = R(t.target).attr("data-title")).substr(1, 1),
            i = e.substr(3, 1),
            ...
            this.endDate || this.container.find(".drp-calendar tbody td").each(function(t, e) {
                var a, i, s, n;
                R(e).hasClass("week") || (i = (a = R(e).attr("data-title")).substr(1, 1),
                s = a.substr(3, 1),
        ...
        clickDate: function(t) {
            ...
            this.endDate || s.isBefore(this.startDate, "day") ? (this.timePicker && (n = parseInt(this.container.find(".left .hourselect").val(), 10),
            this.timePicker24Hour || ("PM" === (r = this.container.find(".left .ampmselect").val()) && n < 12 && (n += 12),
            "AM" === r && 12 === n && (n = 0)),
            ...
            this.endDate = null,
            this.setStartDate(s.clone())) : !this.endDate && s.isBefore(this.startDate) ? this.setEndDate(this.startDate.clone()) : (this.timePicker && (n = parseInt(this.container.find(".right .hourselect").val(), 10),
            this.timePicker24Hour || ("PM" === (r = this.container.find(".right .ampmselect").val()) && n < 12 && (n += 12),
            "AM" === r && 12 === n && (n = 0)),
        ...
        timeChanged: function(t) {
            ...
            this.timePicker24Hour || ("PM" === (n = e.find(".ampmselect").val()) && i < 12 && (i += 12),
            "AM" === n && 12 === i && (i = 0)),
            a ? ((r = this.startDate.clone()).hour(i),
            r.minute(s),
            r.second(h),
            this.setStartDate(r),
            this.singleDatePicker ? this.endDate = this.startDate.clone() : this.endDate && this.endDate.format("YYYY-MM-DD") == r.format("YYYY-MM-DD") && this.endDate.isBefore(r) && this.setEndDate(r.clone())) : this.endDate && ((o = this.endDate.clone()).hour(i),
            o.minute(s),
            o.second(h),
            this.setEndDate(o)),
            this.updateCalendars(),
        ...
        elementChanged: function() {
            ...
            2 === (t = this.element.val().split(this.locale.separator)).length && (e = j(t[0], this.locale.format),
