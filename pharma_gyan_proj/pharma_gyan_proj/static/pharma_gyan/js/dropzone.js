    ...
    _createClass(C, [{
        ...
        value: function(t, e) {
            ...
            if (this.options.params) {
                ...
                for (var v in "function" == typeof m && (m = m.call(this, t, i, t[0].upload.chunked ? this._getChunk(t[0], i) : null)),
                m) {
                    var y = m[v];
                    f.append(v, y)
                }
        ...
        value: function(e, t, n) {
            if (void 0 !== n) {
                ...
                var p = !0
                  ...
                  , f = void 0;
                try {
                    for (var m, v = e[Symbol.iterator](); !(p = (m = v.next()).done); p = !0) {
                        var y = m.value;
                ...
                try {
                    for (var z, x = e[Symbol.iterator](); !(k = (z = x.next()).done); k = !0) {
                        var E = z.value;
                        100 === E.upload.progress && E.upload.bytesSent === E.upload.total || (g = !1),
                        E.upload.progress = b,
                ...
                try {
                    for (var D, T = e[Symbol.iterator](); !(C = (D = T.next()).done); C = !0) {
                        var L = D.value;
                        this.emit("uploadprogress", L, b, L.upload.bytesSent)
                    }
                } catch (e) {
                    _ = !0,
                    S = e
...
Dropzone.discover = function() {
    var s, e;
    return document.querySelectorAll ? s = document.querySelectorAll(".dropzone") : (s = [],
    (e = function(l) {
        return function() {
            var e = []
              , t = !0
